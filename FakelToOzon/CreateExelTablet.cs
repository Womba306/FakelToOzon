        ...
        public void CreateTable()
        {
            ...
            foreach (var builder in jsonToOzon.CreateJson())
            {
                ...
                using (var count_package = new ExcelPackage(new FileInfo(cfilePath)))
                {
                    ...
                    count_worksheet.Cells[count_row, 2].Value = builder.Articule;
                    count_worksheet.Cells[count_row, 3].Value = builder.Name;
                    count_worksheet.Cells[count_row, 4].Value = count; // Ensure count is an integer or numeric value
